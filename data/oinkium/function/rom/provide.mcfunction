...
# インクリメンタル更新チェック
    ...
    execute if score $OinkiumRomDelta Oinkium.Rom matches -10..10 unless score $OinkiumRomDelta Oinkium.Rom matches 0 run return run function oinkium:rom/incremental
