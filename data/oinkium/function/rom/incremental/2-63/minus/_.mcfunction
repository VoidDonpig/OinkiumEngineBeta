#> oinkium:rom/incremental/2-63/minus/_
#
# +2～10の時の処理
#
...
# 繰り上がり
    execute if score $OinkiumRomCheckBorrow Oinkium.Rom matches ..-1 run return run function oinkium:rom/incremental/2-63/minus/borrow
