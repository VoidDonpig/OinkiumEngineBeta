#> oinkium:rom/incremental/2-63/minus/borrow
#
# 繰り上がった時の処理
#
# @within function oinkium:rom/incremental/2-63/minus/_
...
# 3桁以上繰り上がるなら素直にとってくる
    execute if score $OinkiumRomCheckBorrow Oinkium.Rom matches ..-1 run return run function oinkium:rom/shift_data
...
# 13層目を再構築
    ...
    execute if score $OinkiumRomPathIndex_13 Oinkium.Rom matches 2 run data modify storage oinkium:rom _[-4][-4][-4][-4][-4][-4][-4][-4][-4][-4][-4][-4][-4] append from storage oinkium:global TwoEmptyLists[]
    execute if score $OinkiumRomPathIndex_13 Oinkium.Rom matches 3 run data modify storage oinkium:rom _[-4][-4][-4][-4][-4][-4][-4][-4][-4][-4][-4][-4][-4] append from storage oinkium:global ThreeEmptyLists[]
...
# 14層目を再構築
    ...
    execute if score $OinkiumRomPathIndex_14 Oinkium.Rom matches 3 run data modify storage oinkium:rom _[-4][-4][-4][-4][-4][-4][-4][-4][-4][-4][-4][-4][-4][-4] append from storage oinkium:global ThreeEmptyLists[]
