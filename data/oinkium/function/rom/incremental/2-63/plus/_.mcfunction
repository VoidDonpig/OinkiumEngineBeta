#> oinkium:rom/incremental/2-63/plus/_
#
# +2～10の時の処理
#
...
# 繰り上がり
    execute if score $OinkiumRomCheckCarry Oinkium.Rom matches 16.. run return run function oinkium:rom/incremental/2-63/plus/carry
