...
# 検査
    ...
    # 継承元が存在しなかったらエラー
        ...
        execute unless data storage oinkium:asset/object ID run data modify storage oinkium:asset/object ExtendOk._ set value false
    # Finalオブジェクトだったらエラー
        ...
        execute if data storage oinkium:asset/object ExtendOk._{_:true} unless data storage oinkium:asset/object {IsFinal:false} unless data storage oinkium:asset/object ID run data modify storage oinkium:asset/object ExtendOk._ set value false
    # 2つ目以降の継承はAbstractに限定する
        ...
        execute if data storage oinkium:asset/object IsFirstExtendCheckDone[-1]._{_:true} unless data storage oinkium:asset/object {IsAbstract:true} run data modify storage oinkium:asset/object ExtendOk._ set value false
